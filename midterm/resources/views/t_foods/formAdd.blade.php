...
<div class="container beta-relative">
    ...
    <div class="container">
        <form action="admin-add-form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for='inputPromotionPrice'>Old Price</label>
                <input type="number" min=10000 class="form-control" name="inputOldPrice" id="inputPromotionPrice" placeholder="Enter promotion price">
            </div>
